...
public:
    ...
    int speed;
    int player_num;
    Paddle(float px, float py, int w, int h, int pl){
        posX = px;
        posY = py;
        width = w;
        height = h;
...
int main() {
    ...
    Paddle p1(10, screen_height/2 - 60, 25, 120, 2);
    Paddle p2(screen_width - 35, screen_height/2 - 60, 25, 120, 1);
    ...
    while(WindowShouldClose() == false){
        ...
        DrawText(TextFormat("%i",player2_score), screen_width * 3/4 - 20, 20, 80, WHITE);
        EndDrawing();
    }
